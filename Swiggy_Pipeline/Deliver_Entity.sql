...
list @stage_sch.csv_stg/initial/delivery-load/;

-- this table may have additional information like pickup time, accept time etc.
...
from (
    ...
    from @stage_sch.csv_stg/initial/delivery-load/delivery-initial-load.csv t
)
